...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<String> inputStrings = Arrays.stream(reader.readLine().split(", ")).collect(Collectors.toList());

        target = reader.readLine();

        inputStrings = inputStrings.stream().filter(str -> target.contains(str)).collect(Collectors.toList());
