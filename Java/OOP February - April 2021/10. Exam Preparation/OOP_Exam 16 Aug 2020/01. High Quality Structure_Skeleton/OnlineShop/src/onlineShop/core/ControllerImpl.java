...
public class ControllerImpl implements Controller {
    ...
    public String removeComponent(String componentType, int computerId) {
        ...
        computerCheck.removeComponent(componentType);
    ...
    public String removePeripheral(String peripheralType, int computerId) {
        ...
        computerCheck.removePeripheral(peripheralType);
    ...
    public String buyComputer(int id) {
        Computer searchComputer = this.computers.stream().filter(c -> c.getId() == id).findFirst().orElse(null);
    ...
    public String BuyBestComputer(double budget) {
        ...
        if (!this.computers.isEmpty()) {
            Collections.sort(this.components, (c1, c2) -> Double.compare(c1.getOverallPerformance(), c2.getOverallPerformance()));
        ...
        if (this.computers.isEmpty() || foundComp == null) {
